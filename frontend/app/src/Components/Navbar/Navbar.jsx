...
const Navbar = ({className}) => {
  ...
  return (
    <div className={`bg-white sticky top-0 z-10 ${className}`}>
      <div className="navbar flex justify-between items-center pt-4 py-4">
        ...
        <div className="cart md:flex gap-5 items-center">
          ...
          <div className="quantity-icon absolute bg-[#7b8d6a] rounded-2xl px-2 w-0 h-4 md:top-[2.9rem] md:right-[6.5rem] flex justify-center items-center mobile:top-10 mobile:right-[2.5rem] text-white">
